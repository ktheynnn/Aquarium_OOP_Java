...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println(" "); // просто приветсвенная надпись
            System.out.println("Hello! This is the Aqua Shop!");
            System.out.println("Let`s try to buy you a new aquarium with fishes ,reptiles and more! ");
            System.out.println("So, please choose a thing that you need in your aquarium.");
            System.out.println(" ");
            while (true){
